...
<!-- Mirrored from adminlte.io/themes/v3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Sep 2023 10:40:06 GMT -->
@php
...
<head>
    ...
    <script nonce="183c0e50-4754-43a5-8066-f60b41d1bbdc" src="{{ asset('assets/dist/js/plugin.js') }}"></script>
    <style>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <a href="{{ route('dashboard') }}"
                                class="nav-link {{ $current_page_link === 'admin/dashboard' ? 'bg-gradient-primary active' : '' }}">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        @if ($segment == 'categories')
                            <div class="col-sm-6">
                                <button type="button" class="btn bg-gradient-navy btn-sm float-right"
...
<!-- Mirrored from adminlte.io/themes/v3/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Sep 2023 10:40:39 GMT -->
